...
type TCartContext = {
    ...
    updateCart: (inputQuantity: number, data: TProduct) => void,
...
const CartProvider = (props: any) => {
    ...
    return (
        <CartContext.Provider value={{ cart: cart, setCart, addToCart, updateCart, increaseFromCart, decreaseFromCart, removeAllFromCart }}>
            {props.children}
